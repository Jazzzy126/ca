...
/// @nodoc
mixin _$TokenModel implements DiagnosticableTreeMixin {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TokenModel(tokenType: $tokenType, accessToken: $accessToken, expiresIn: $expiresIn, refreshToken: $refreshToken)';
  }
}
...
/// @nodoc
@JsonSerializable()
class _TokenModel with DiagnosticableTreeMixin implements TokenModel {
  const _TokenModel(
