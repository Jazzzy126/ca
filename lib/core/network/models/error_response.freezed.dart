...
abstract mixin class $ErrorResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'error_msg') String errorMsg});
}
...
extension ErrorResponsePatterns on ErrorResponse {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: 'error_msg') String errorMsg)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ErrorResponse() when $default != null:
        return $default(_that.errorMsg);
      case _:
        return orElse();
    }
  }
...
class _ErrorResponse with DiagnosticableTreeMixin implements ErrorResponse {
  const _ErrorResponse({@JsonKey(name: 'error_msg') required this.errorMsg});
